    ...
    <div class="col">
        ...
        <div class="col-11 d-flex justify-content-center">
          <table style="width:80%">
            ...
            <tr v-for="employee in employees">
              ...
              <button v-show="!disabledEdit" @click="activeEmployee = employee" :disabled="disabledEdit"
                class="btn my-2 my-sm-0 d-flex  align-self-end" data-toggle="modal" data-target="#editEmployeeModal"><i
                  class="smallme fas fa-pen"></i></button>
            </tr>
          </table>
        </div>
      </div>
      ...
      <div class="row fixed-bottom text-center">
        <div class="col">
          ...
          <button class="btn my-2 my-sm-0" @click="showAddEmployee = !showAddEmployee"><i
      ...
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 @click="editName = !editName" class="modal-title" id="exampleModalLongTitle">{{activeEmployee.name}}
            </h5>
          ...
          <div class="modal-body row">
            <div class="col-6 offset-3">
              ...
              <div class="form-check">
                <input class="form-check-input" type="checkbox" v-model="activeEmployee.employmentStatus"
                  id="defaultCheck1">
