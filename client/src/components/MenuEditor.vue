      ...
      <div class="col-4 d-flex  ">
        <table style="width:75% text-center">
          ...
          <tr v-for="entree in entrees">
            ...
            <td @click="toggleEntreeActive(entree)" class="pl-3 pt-2">{{entree.active}}</td>
            <td @click="toggleEntreeSpecial(entree)" class="pl-3 pt-2">{{entree.special}}</td>
          </tr>
        </table>
      </div>
      <div class="col-3 d-flex">
        <table style="width:75% text-center">
          ...
          <tr v-for="side in sides">
            ...
            <td @click="toggleSideActive(side)" class="pl-3 pt-2">{{side.active}}</td>
          </tr>
        </table>
      </div>
      <div class="col-3 d-flex">
        <table style="width:75% text-center">
          ...
          <tr v-for="drink in drinks">
            ...
            <td @click="toggleDrinkActive(drink)" class="pl-3 pt-2">{{drink.active}}</td>
          </tr>
        </table>
      </div>
      </div>
